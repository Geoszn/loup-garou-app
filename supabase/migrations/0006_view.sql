-- ============================================================================
-- get_my_game_view : point d'entrée unique de lecture pour le client.
-- Calcule tout ce que l'utilisateur courant a le droit de voir, y compris
-- son propre rôle secret, sans jamais exposer le rôle des autres joueurs
-- vivants qui ne sont pas ses coéquipiers loups-garous.
-- ============================================================================
