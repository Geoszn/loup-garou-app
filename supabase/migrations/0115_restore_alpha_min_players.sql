-- ============================================================================
-- Restaure la contrainte "10 joueurs minimum pour le Loup Alpha", retirée
-- temporairement par la migration 0114 pour permettre de tester le
-- correctif du pop-up éliminer/infecter sans réunir 10 vraies personnes.
-- Tests terminés (confirmé par l'utilisateur) — retour à la règle
-- officielle du jeu, sans aucun autre changement.
-- ============================================================================
