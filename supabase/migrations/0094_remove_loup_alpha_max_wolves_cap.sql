-- Demande utilisateur : retirer la contrainte "au plus 2 Loups-Garous
-- simples" pour activer le Loup Alpha (introduite en migration 0088, à
-- l'époque où il remplaçait le vote collectif par une décision solo — plus
-- pertinent depuis la refonte 0093, où il vote avec le reste de la meute).
-- Seule la contrainte des 10 joueurs minimum est conservée.
