...
export const translations = {
  ...
  'notifPrefs.all': { fr: 'Rappels personnalisés', en: 'Personalised reminders' },
  'notifPrefs.quests': { fr: 'Quêtes', en: 'Quests' },
  'notifPrefs.questsHint': { fr: 'Récompense à récupérer, quête presque terminée.', en: 'Reward to claim, quest almost done.' },
  'notifPrefs.streak': { fr: 'Série de connexion', en: 'Login streak' },
  'notifPrefs.streakHint': { fr: 'Quand ta série risque de s’arrêter.', en: 'When your streak is about to end.' },
  'notifPrefs.games': { fr: 'Parties', en: 'Games' },
  'notifPrefs.gamesHint': { fr: 'Un ami lance une partie, une partie publique se remplit.', en: 'A friend starts a game, a public game is filling up.' },
  'notifPrefs.progress': { fr: 'Progression', en: 'Progress' },
  'notifPrefs.progressHint': { fr: 'Quand tu es proche d’un nouveau rang.', en: 'When you are close to a new rank.' },
  'notifPrefs.comeback': { fr: 'Nouvelles du village', en: 'News from the village' },
  'notifPrefs.comebackHint': { fr: 'Un message si tu es absent plusieurs jours.', en: 'A message if you have been away for several days.' },
  'notifPrefs.limits': { fr: 'Au plus une notification par jour, jamais entre 22h et 9h.', en: 'At most one notification a day, never between 10pm and 9am.' },
  'avatar.title': { fr: 'Mon avatar', en: 'My avatar' },
  'avatar.customize': { fr: 'Personnaliser', en: 'Customise' },
  'avatar.save': { fr: 'Enregistrer', en: 'Save' },
  'avatar.skin': { fr: 'Teint', en: 'Skin tone' },
  'avatar.hair': { fr: 'Coiffure', en: 'Hairstyle' },
  'avatar.outfit': { fr: 'Tenue', en: 'Outfit' },
  'avatar.acc': { fr: 'Accessoire', en: 'Accessory' },
  'avatar.bg': { fr: 'Fond', en: 'Background' },
  'avatar.locked': { fr: '{{points}} pts', en: '{{points}} pts' },
  'avatar.hint': { fr: 'Ton avatar apparaît dans le salon, le vocal et la grille des joueurs. Les pièces verrouillées se débloquent avec tes points de rang.', en: 'Your avatar shows in the lobby, voice chat and player grid. Locked pieces unlock with your rank points.' },
  'avatar.hair.none': { fr: 'Rasé', en: 'Shaved' },
  'avatar.hair.fade': { fr: 'Court', en: 'Short' },
  'avatar.hair.afro': { fr: 'Afro', en: 'Afro' },
  'avatar.hair.braids': { fr: 'Tresses', en: 'Braids' },
  'avatar.hair.locs': { fr: 'Locks', en: 'Locs' },
  'avatar.hair.bun': { fr: 'Chignon', en: 'Bun' },
  'avatar.hair.gele': { fr: 'Gele', en: 'Gele' },
  'avatar.outfit.tunic': { fr: 'Tunique', en: 'Tunic' },
  'avatar.outfit.cloak': { fr: 'Cape', en: 'Cloak' },
  'avatar.outfit.kente': { fr: 'Kente', en: 'Kente' },
  'avatar.outfit.hood': { fr: 'Capuche loup', en: 'Wolf hood' },
  'avatar.acc.none': { fr: 'Aucun', en: 'None' },
  'avatar.acc.ring': { fr: 'Anneaux', en: 'Rings' },
  'avatar.acc.glasses': { fr: 'Lunettes', en: 'Glasses' },
  'avatar.acc.scar': { fr: 'Cicatrice', en: 'Scar' },
  'avatar.hair.puffs': { fr: 'Macarons', en: 'Puffs' },
  'avatar.hair.curly': { fr: 'Bouclés', en: 'Curls' },
  'avatar.hair.flat': { fr: 'Carré', en: 'Flat top' },
  'avatar.hair.cornrows': { fr: 'Nattes collées', en: 'Cornrows' },
  'avatar.hair.long': { fr: 'Longs', en: 'Long' },
  'avatar.hair.knots': { fr: 'Bantu knots', en: 'Bantu knots' },
  'avatar.hair.mohawk': { fr: 'Crête', en: 'Mohawk' },
  'avatar.hair.topknot': { fr: 'Chignon locks', en: 'Loc bun' },
  'avatar.outfit.tee': { fr: 'T-shirt', en: 'T-shirt' },
  'avatar.outfit.wrap': { fr: 'Pagne', en: 'Wrap cloth' },
  'avatar.outfit.dashiki': { fr: 'Dashiki', en: 'Dashiki' },
  'avatar.outfit.boubou': { fr: 'Boubou', en: 'Boubou' },
  'avatar.outfit.hunter': { fr: 'Chasseur', en: 'Hunter' },
  'avatar.outfit.suit': { fr: 'Costume', en: 'Suit' },
  'avatar.outfit.armor': { fr: 'Armure', en: 'Armor' },
  'avatar.outfit.royal': { fr: 'Royal', en: 'Royal' },
  'avatar.outfit.furcape': { fr: 'Peau de loup', en: 'Wolf pelt' },
  'avatar.acc.freckles': { fr: 'Taches', en: 'Freckles' },
  'avatar.acc.sunglasses': { fr: 'Lunettes noires', en: 'Sunglasses' },
  'avatar.acc.hoops': { fr: 'Créoles', en: 'Hoops' },
  'avatar.acc.beads': { fr: 'Perles', en: 'Beads' },
  'avatar.acc.facepaint': { fr: 'Peinture', en: 'Face paint' },
  'avatar.acc.eyepatch': { fr: 'Cache-œil', en: 'Eye patch' },
  'avatar.head.none': { fr: 'Aucun', en: 'None' },
  'avatar.head.headband': { fr: 'Bandeau', en: 'Headband' },
  'avatar.head.cap': { fr: 'Casquette', en: 'Cap' },
  'avatar.head.hat': { fr: 'Chapeau', en: 'Hat' },
  'avatar.head.feather': { fr: 'Plume', en: 'Feather' },
  'avatar.head.crown': { fr: 'Couronne', en: 'Crown' },
  'avatar.tab.looks': { fr: 'Looks', en: 'Looks' },
  'avatar.tab.skin': { fr: 'Teint', en: 'Skin' },
  'avatar.tab.hair': { fr: 'Cheveux', en: 'Hair' },
  'avatar.tab.outfit': { fr: 'Tenue', en: 'Outfit' },
  'avatar.tab.head': { fr: 'Chapeau', en: 'Headwear' },
  'avatar.tab.acc': { fr: 'Détails', en: 'Details' },
  'avatar.tab.bg': { fr: 'Fond', en: 'Back' },
  'avatar.look.sage': { fr: 'Le Sage', en: 'The Sage' },
  'avatar.look.queen': { fr: 'La Reine', en: 'The Queen' },
  'avatar.look.hunter': { fr: 'Le Chasseur', en: 'The Hunter' },
  'avatar.look.griot': { fr: 'La Griotte', en: 'The Griot' },
  'avatar.look.warrior': { fr: 'Le Guerrier', en: 'The Warrior' },
  'avatar.look.wolf': { fr: 'Le Loup', en: 'The Wolf' },
  'avatar.random': { fr: 'Aléatoire', en: 'Random' },
  'avatar.undo': { fr: 'Annuler', en: 'Undo' },
  'avatar.redo': { fr: 'Rétablir', en: 'Redo' },
  'avatar.reset': { fr: 'Revenir à l’avatar enregistré', en: 'Back to saved avatar' },
  'avatar.dirty': { fr: 'Modifications non enregistrées', en: 'Unsaved changes' },
  'avatar.saveFull': { fr: 'Enregistrer mon avatar', en: 'Save my avatar' },
  'avatar.preview': { fr: 'Aperçu', en: 'Preview' },
  'avatar.mood.smile': { fr: 'Sourire', en: 'Smile' },
  'avatar.mood.sleep': { fr: 'Nuit', en: 'Night' },
  'avatar.mood.shock': { fr: 'Surpris', en: 'Surprised' },
  'avatar.mood.talk': { fr: 'Parle', en: 'Talking' },
  'avatar.mood.dead': { fr: 'Éliminé', en: 'Eliminated' },
  'avatar.lockedMsg': { fr: 'Cette pièce se débloque à {{points}} points ({{tier}}). Il te manque {{missing}} points.', en: 'This piece unlocks at {{points}} points ({{tier}}). You need {{missing}} more points.' },
  'avatar.discardTitle': { fr: 'Abandonner les modifications ?', en: 'Discard your changes?' },
  'avatar.discardMessage': { fr: 'Tes changements ne sont pas enregistrés.', en: 'Your changes are not saved.' },
  'avatar.discardConfirm': { fr: 'Abandonner', en: 'Discard' },
  'avatar.discardCancel': { fr: 'Continuer', en: 'Keep editing' },
  'avatar.editName': { fr: 'Modifier le pseudo', en: 'Edit username' },
  'avatar.tab.face': { fr: 'Visage', en: 'Face' },
  'avatar.face.oval': { fr: 'Ovale', en: 'Oval' },
  'avatar.face.round': { fr: 'Rond', en: 'Round' },
  'avatar.face.square': { fr: 'Carré', en: 'Square' },
  'avatar.face.long': { fr: 'Allongé', en: 'Long' },
  'avatar.face.heart': { fr: 'Cœur', en: 'Heart' },
  'announce.counter': { fr: 'Annonce {{n}} sur {{total}}', en: 'Announcement {{n}} of {{total}}' },
  'announce.skip': { fr: 'Passer', en: 'Skip' },
  'announce.next': { fr: 'Suivant →', en: 'Next →' },
  'announce.avatars.badge': { fr: 'Nouveauté', en: 'New' },
  'announce.avatars.title': { fr: 'Les avatars arrivent !', en: 'Avatars are here!' },
  'announce.avatars.body': { fr: 'Crée ton personnage : visage, coiffure, tenue, chapeau… Il t’accompagne dans le salon, le chat, le vocal et le classement.', en: 'Create your character: face, hairstyle, outfit, hat… It follows you in the lobby, the chat, voice chat and the leaderboard.' },
  'announce.avatars.bullet1': { fr: 'Plus de 50 pièces à débloquer avec tes points de rang', en: '50+ pieces to unlock with your rank points' },
  'announce.avatars.bullet2': { fr: 'Il dort la nuit, s’étonne au réveil, parle quand tu parles', en: 'It sleeps at night, gasps at dawn, and talks when you talk' },
  'announce.avatars.cta': { fr: 'Créer mon avatar', en: 'Create my avatar' },
  'announce.avatars.later': { fr: 'Plus tard', en: 'Later' },
  'announce.avatars.createNow': { fr: 'Créer mon avatar maintenant', en: 'Create my avatar now' },
  'notifPrefs.customize': { fr: 'Choisir les types', en: 'Choose types' },
  'notifPrefs.groupQuests': { fr: 'Quêtes et série', en: 'Quests and streak' },
  'notifPrefs.groupQuestsHint': { fr: 'Récompense à récupérer, série en danger.', en: 'Reward to claim, streak at risk.' },
  'notifPrefs.groupGames': { fr: 'Parties', en: 'Games' },
  ...
  'hub.title': { fr: 'Récompenses', en: 'Rewards' },
  'hub.menu.quests': { fr: 'Quêtes', en: 'Quests' },
  'hub.menu.store': { fr: 'Store', en: 'Store' },
  'hub.menu.season': { fr: 'Saison', en: 'Season' },
  'hub.soon': { fr: 'Bientôt', en: 'Soon' },
  'hub.soonFull': { fr: 'Bientôt disponible', en: 'Coming soon' },
  'hub.quests.daily': { fr: 'Du jour', en: 'Daily' },
  'hub.quests.season': { fr: 'Saisonnières', en: 'Seasonal' },
  'hub.quests.resetIn': { fr: 'Nouvelles quêtes dans {{time}}', en: 'New quests in {{time}}' },
  'hub.quests.seasonTitle': { fr: 'Quêtes saisonnières', en: 'Seasonal quests' },
  'hub.quests.seasonBody': { fr: 'Des défis plus longs, avec des récompenses exclusives, arrivent avec la Saison 1.', en: 'Longer challenges with exclusive rewards are coming with Season 1.' },
  'hub.season.title': { fr: 'Saison 1', en: 'Season 1' },
  'hub.season.body': { fr: 'Un classement remis à zéro, des quêtes saisonnières et des récompenses exclusives. On t’annonce la date très bientôt.', en: 'A fresh leaderboard, seasonal quests and exclusive rewards. We will announce the date very soon.' },
  'hub.season.f1.title': { fr: 'Classement de saison', en: 'Season leaderboard' },
  'hub.season.f1.body': { fr: 'Grimpe les rangs et gagne des récompenses de fin de saison.', en: 'Climb the ranks and win end-of-season rewards.' },
  'hub.season.f2.title': { fr: 'Quêtes saisonnières', en: 'Seasonal quests' },
  'hub.season.f2.body': { fr: 'Des défis plus longs, pour aller plus loin.', en: 'Longer challenges to go further.' },
  'hub.season.f3.title': { fr: 'Récompenses exclusives', en: 'Exclusive rewards' },
  'hub.season.f3.body': { fr: 'Des skins et artefacts introuvables ailleurs.', en: 'Skins and artifacts you cannot get anywhere else.' },
  'hub.store.artifacts': { fr: 'Artefacts', en: 'Artifacts' },
  'hub.store.skins': { fr: 'Skins', en: 'Skins' },
  'hub.skins.intro': { fr: 'Des pièces exclusives pour ton avatar, en plus de celles que tu débloques avec tes points de rang.', en: 'Exclusive pieces for your avatar, on top of those you unlock with rank points.' },
  'hub.skins.cat.tenues': { fr: 'Tenues', en: 'Outfits' },
  'hub.skins.cat.coiffures': { fr: 'Coiffures', en: 'Hairstyles' },
  'hub.skins.cat.chapeaux': { fr: 'Chapeaux', en: 'Hats' },
  'hub.skins.cat.packs': { fr: 'Packs', en: 'Packs' },
  'hub.skins.rarity.commun': { fr: 'Commun', en: 'Common' },
  'hub.skins.rarity.rare': { fr: 'Rare', en: 'Rare' },
  'hub.skins.rarity.epique': { fr: 'Épique', en: 'Epic' },
  'hub.skins.rarity.legendaire': { fr: 'Légendaire', en: 'Legendary' },
  'hub.skins.equip': { fr: 'Équiper', en: 'Equip' },
  'hub.skins.equipDone': { fr: 'Skin équipé', en: 'Skin equipped' },
  'hub.skins.bought': { fr: 'Skin acheté', en: 'Skin purchased' },
  'hub.missing': { fr: 'Il te manque {{coins}} Loup Coins.', en: 'You need {{coins}} more Loup Coins.' },
  'hub.empty': { fr: 'Rien à afficher pour l’instant.', en: 'Nothing to show yet.' },
  'hub.seeAll': { fr: 'Historique et mes artefacts', en: 'History and my artifacts' },
  ...
  'loupCoins.viewStore': { fr: 'Voir le Loup Store →', en: 'View the Loup Store →' },
  'loupStore.pageTitle': { fr: 'Loup Store', en: 'Loup Store' },
  'loupStore.subtitle': {
    fr: 'Ton compte de Loup Coins, tout en un endroit.',
    en: 'Your Loup Coins account, all in one place.',
  },
  'loupStore.balance': { fr: 'Solde actuel', en: 'Current balance' },
  'loupStore.totalEarned': { fr: 'Total gagné', en: 'Total earned' },
  'loupStore.totalSpent': { fr: 'Total dépensé', en: 'Total spent' },
  'loupStore.comingSoon': {
    fr: 'D’autres façons d’utiliser tes Loup Coins arrivent bientôt.',
    en: 'More ways to use your Loup Coins are coming soon.',
  },
  'loupStore.history.title': { fr: 'Historique', en: 'History' },
  'loupStore.history.empty': {
    fr: 'Aucune transaction pour l’instant. Réclame une quête pour commencer à gagner des Loup Coins !',
  ...
  'loupStore.boutique.buyMore': { fr: 'Racheter', en: 'Buy another' },
  'loupStore.boutique.owned': { fr: 'Possédé', en: 'Owned' },
  'loupStore.boutique.stock': { fr: 'Stock : {{quantity}} / {{max}}', en: 'Stock: {{quantity}} / {{max}}' },
  'loupStore.boutique.onCooldown': {
    fr: 'Stock épuisé pour l’instant — reviens plus tard pour en racheter.',
    en: 'Out of stock for now — come back later to buy more.',
  },
  'loupStore.boutique.confirmTitle': { fr: 'Confirmer l’achat', en: 'Confirm purchase' },
  'loupStore.boutique.confirmMessage': {
    fr: 'Acheter « {{name}} » pour {{price}} Loup Coins ?',
    en: 'Buy "{{name}}" for {{price}} Loup Coins?',
  },
  'loupStore.tabs.boutique': { fr: 'Boutique', en: 'Shop' },
  'loupStore.tabs.myArtifacts': { fr: 'Mes Artefacts', en: 'My Artifacts' },
  'loupStore.tabs.history': { fr: 'Historique', en: 'History' },
  'loupStore.myArtifacts.title': { fr: 'Mes Artefacts', en: 'My Artifacts' },
  'loupStore.myArtifacts.subtitle': {
    fr: 'Tout ce que tu possèdes, avec le stock restant pour les artefacts rechargeables.',
    en: 'Everything you own, with remaining stock for rechargeable artifacts.',
  },
  'loupStore.myArtifacts.empty': {
    fr: 'Tu ne possèdes encore aucun artefact — direction la Boutique !',
    en: 'You don’t own any artifacts yet — head to the Shop!',
  },
  'loupStore.myArtifacts.stock': { fr: 'Stock {{quantity}}/{{max}}', en: 'Stock {{quantity}}/{{max}}' },
  'loupStore.myArtifacts.canBuyNow': { fr: 'rachat possible maintenant', en: 'can buy more now' },
  'loupStore.myArtifacts.nextPurchase': { fr: 'prochain rachat le {{date}}', en: 'next purchase on {{date}}' },
