...
function EndScreen({
  ...
  // Nom de l'Ange pour l'explication — cherché dans TOUS les joueurs (jamais
  // seulement les vivants, contrairement à Anancy) : sa victoire exige
  // justement d'être mort, donc il n'apparaît par définition jamais dans
  // alivePlayers.
